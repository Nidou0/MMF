...
$php_main_email = "hope@happylife.institute";

// Fetching Values from URL
$php_name = $_POST['ajax_name'];
$php_email = $_POST['ajax_email'];
$php_message = $_POST['ajax_message'];
$php_subject = $_POST['ajax_subject'];  // Existing subject field
$php_dropdown = $_POST['Therapist_choice'];  // New dropdown field
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
    ...
    $php_template = '<div style="padding:50px;">Hello ' . $php_name . ',<br/>'
        ...
        . '<strong style="color:#f00a77;">Dropdown Value:</strong>  ' . $php_dropdown . '<br/>'
