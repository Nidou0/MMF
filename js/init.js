...
function dizme_tm_contact_form() {
    ...
    jQuery(".contact_form #send_message").on('click', function () {
        ...
        var subject = jQuery(".contact_form #subject").val();  // Existing code for subject field

        // New code to get selected value from the dropdown
        var dropdownValue = jQuery(".contact_form #Therapist_choice").val();

        var success = jQuery(".contact_form .returnmessage").data('success');

        jQuery(".contact_form .returnmessage").empty();

        if (name === '' || email === '' || message === '' || dropdownValue === '') {
            ...
            jQuery.post("modal/contact.php", {
                ...
                ajax_dropdown: dropdownValue  // Include the dropdown value in the data sent to the server
            }, function (data) {
